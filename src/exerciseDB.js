...
const RUNTIME_META = {
  ...
  "Calf Press, Leg Press":      { tier:"ISO", prPts:3 },
  "Calf Raise, Hack Squat":     { tier:"ISO", prPts:3 },
...
export const MOVEMENT_CLUSTERS = {
  ...
  "Calf Press":        ["Calf Press, Leg Press","Calf Press, Linear Leg Press"],
  "Calf Raise":        ["Calf Raise, Machine, Plate-Loaded, Seated","Calf Raise, Smith Machine","Calf Raise, Hack Squat"],
